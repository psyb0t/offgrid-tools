...
log "  🔨 Development tools - go, python, php, geany, build-essential, gcc, g++, make, cmake, gdb, valgrind, git"
...
log "  📻 Software Defined Radio - gqrx-sdr, gnuradio, gr-osmosdr, rtl-sdr"
log "  📡 Radio software tools - fldigi, qsstv, direwolf, gpredict, multimon-ng"
log "  🔊 Audio/data tools - sox, gnuplot"
log "  🎵 Audio streaming - butt, mixxx"
log "  🔒 Security - ufw, keepassxc, ssh client/server, aircrack-ng, mdk4"
log "  💾 Disk tools - testdisk, gparted, ntfs-3g, gddrescue, gnome-disks"
log "  📦 Archive utilities - zip, unzip, rar, unrar, 7zip, tar, gzip, bzip2, xz, zstd, arj, lzip, cabextract"
